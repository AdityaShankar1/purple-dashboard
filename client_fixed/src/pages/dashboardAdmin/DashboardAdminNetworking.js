    ...
    <div className="bg-[var(--bg-primary)] min-h-screen p-8 space-y-8">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h1 className="text-4xl font-extrabold text-slate-900 dark:text-[#f6e6f7] tracking-tight">Networking</h1>
        </div>
        <p className="text-slate-600 dark:text-slate-400 font-medium ml-1">Monitor network traffic and firewall activity</p>
      </div>
